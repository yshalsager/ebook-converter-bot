...
from ebook_converter_bot.utils.telegram import tg_exceptions_handler, get_chat_type, get_chat_name
...
@BOT.on(events.chataction.ChatAction(func=lambda event: event.user_added and BOT_INFO['id'] == event.user_id))

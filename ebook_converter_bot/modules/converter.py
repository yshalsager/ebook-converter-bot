...
def options_labels(lang: str) -> dict[str, str]:
    return {
        ...
        "pdf_no_cover_label": _("PDF: no cover page", lang),
        "pdf_no_chapter_pagebreak_label": _("PDF: no chapter page breaks", lang),
...
def render_options_summary(state: ConversionRequestState, lang: str) -> str:
    summary_parts = [
        ...
        for enabled, text in (
            ...
            (state.pdf_no_chapter_pagebreak, _("PDF: no chapter page breaks", lang)),
            (
